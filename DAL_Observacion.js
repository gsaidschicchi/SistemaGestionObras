...
class DAL_Observacion {
  ...
  static listar(){return DAL_Base.filas(Config.HOJAS.OBSERVACIONES,14);} static insertar(f){return DAL_Base.insertar(Config.HOJAS.OBSERVACIONES,f);} static actualizar(n,f){DAL_Base.actualizar(Config.HOJAS.OBSERVACIONES,n,f);}
  static eliminarFisico(n){return DAL_Base.eliminarFila(Config.HOJAS.OBSERVACIONES,n);}
}
